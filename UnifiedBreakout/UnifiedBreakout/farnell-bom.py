...
"""
    ...
    Command line:
    python3 "/path/to/bom-generator.py" "%I" "%O.csv"
"""
...
partfields -= set( ['Reference', 'Value', 'Datasheet', 'Footprint', 'Farnell PN', 'Alternative MPN'] )

columnset = compfields | partfields     # union

# prepend an initial 'hard coded' list and put the enchillada into list 'columns'
columns = ['Item', 'Qty', 'Reference(s)', 'Value', 'Footprint', 'Datasheet'] + sorted(list(columnset))
